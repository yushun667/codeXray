/**
 * 数据流图：将解析引擎 data_flow 查询结果转为通用 nodes/edges
 */
...
/**
 * data_flow 数据 -> 通用 nodes/edges（position 由布局引擎后续计算）
 */
export function adaptDataFlow(data: GraphData): { nodes: AdapterNode<FlowNodeData>[]; edges: AdapterEdge[] } {
